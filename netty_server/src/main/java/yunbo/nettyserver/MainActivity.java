...
import yunbo.nettyserver.adapter.CustomSpinnerAdapter;
import yunbo.nettyserver.adapter.LogAdapter;
import yunbo.nettyserver.bean.ClientChanel;
import yunbo.nettyserver.bean.LogBean;
import yunbo.nettyserver.netty.NettyServerListener;
import yunbo.nettyserver.netty.NettyTcpServer;
import yunbo.nettyserver.utils.NetworkUtils;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, NettyServerListener<String> {
    ...
    private void initData() {
       ...
       try{
           tv_ip.setText("内网IP: " + NetworkUtils.getLocalIPAddress());
       }catch (Exception e){
